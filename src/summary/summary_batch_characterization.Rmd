---
title: "Summary_batch_characterization"
author: "Almut Lütge"
...
m_batch <- mean(asin(vp_sub[, "vp_batch"]))
m_celltype <- mean(asin(vp_sub[, "vp_celltype"]))
...
```{r tern plots gene class, fig.asp=0.66, warning=FALSE}
